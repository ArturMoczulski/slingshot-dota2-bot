...
var onSteamLogOn = function onSteamLogOn(logonResp) {
        if (logonResp.eresult == steam.EResult.OK) {
            ...
            steamFriends.setPersonaName("$ling$hot-bot"); // to change its nickname
            util.log("Logged on.");
            Dota2.launch();
            Dota2.on("ready", function() {
                ...
                /* CHAT */
                // Event based
                // Dota2.joinChat("$ling$hot-test-chat");
                // setTimeout(function(){ Dota2.sendMessage("$ling$hot-test-chat", "$ling$hot in your face"); }, 5000);
                /* GUILD */
